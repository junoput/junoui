...
| Checkbox / radio                 | `.juno-checkbox` `.juno-radio` `.juno-choice`             | [checkbox.md](./checkbox.md)               |
...
| Popover                          | `.juno-popover` `.juno-popover-anchor`                    | [popover.md](./popover.md)                 |
| Menu / dropdown                  | `.juno-menu`                                              | [menu.md](./menu.md)                       |
| Table / data grid                | `.juno-table` `.juno-table-scroll`                        | [table.md](./table.md)                     |
| Alert / inline notification      | `.juno-alert`                                             | [alert.md](./alert.md)                     |
| Toast / snackbar                 | `.juno-toast` `.juno-toast-stack`                         | [toast.md](./toast.md)                     |
...
| Load state (shimmer/fault/empty) | `.juno-state` `.juno-shimmer` `.juno-fault` `.juno-empty` | [load-state.md](./load-state.md)           |
| Reload (refetch-in-place)        | `.juno-reload`                                            | [reload.md](./reload.md)                   |
| Thumb / media placeholder        | `.juno-thumb`                                             | [thumb.md](./thumb.md)                     |
| Avatar                           | `.juno-avatar` `.juno-avatar-group`                       | [avatar.md](./avatar.md)                   |
