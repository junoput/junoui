...
| `.juno-pillbar--responsive`                                                    | Shows only where `.juno-rail--responsive` hides — the pointer-aware half of the rail↔pillbar swap; see [dock-responsive.md](./dock-responsive.md). |
