...
for (const p of PALETTES) {
  ...
  for (const role of ROLES) {
    const dv = TOKENS[p].dark[role], lv = TOKENS[p].light[role];
...
md += `## Core tokens\n\n`;
const TITLES = {
  space: 'Spacing', radius: 'Radius', border: 'Borders',
  size: 'Sizing', font: 'Typography',
};
...
writeFileSync('docs/tokens-reference.md', md);
console.log('✓ wrote docs/tokens-reference.md');
