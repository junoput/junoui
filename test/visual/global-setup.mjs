...
export default function globalSetup() {
  ...
  process.stderr.write(
    [
      ...
      '        - no fontconfig config on this box (no /etc/fonts/fonts.conf, no',
      '          fc-list binary) makes Skia hit an unimplemented path on ANY',
      '          text render — not page-specific, not date-input-specific — and',
      '          the renderer dies with SIGTRAP. Fix: FONTCONFIG_FILE pointing at',
