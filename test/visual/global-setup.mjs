...
export default function globalSetup() {
  ...
  process.stderr.write(
    [
      ...
      '  BEFORE any test result, read which call threw: `browserType.launch:` means',
      '  the browser never started, not that a page killed it. On this box that is',
      '  the staged Chromium libraries missing from the environment —',
      '  LD_LIBRARY_PATH=~/.local/chromium-libs/extracted/usr/lib/x86_64-linux-gnu',
      '  (20260918-002). The two messages are identical, so the launch failure is',
      '  routinely misread as a defect in whichever page ran first.',
      '',
