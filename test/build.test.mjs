...
test('every var(--juno-*) used in src/css is defined in the token output', () => {
  ...
  const local = new Set([
    ...
    'juno-safe-bottom',
    'juno-safe-left',
    'juno-pillbar-edge-offset',
    'juno-toast-edge-offset',
    'juno-toast-edge-offset-top',
    'juno-toast-edge-offset-inline-end',
    'juno-toast-edge-offset-inline-start',
    'juno-pillbar-items',
